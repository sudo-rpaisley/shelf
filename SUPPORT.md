...
- **Docs:** [docs/](docs/README.md) — installation, configuration, a full
  user guide, [FAQ](docs/faq.md) and [troubleshooting](docs/troubleshooting.md).
- **Bugs:** [open an issue](https://github.com/sudo-rpaisley/shelf/issues/new/choose)
  with your Shelf version or commit, browser/device and relevant log lines
