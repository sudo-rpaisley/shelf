(function () {
    async function addAction() {
        ...
        // Prefer the explicit service-action mount provided by the refreshed
        // detail template. Fall back to the old structural selector so the
        // script remains compatible during rolling upgrades.
        ...
        if (!target || target.querySelector('[data-komga-action]')) return;
