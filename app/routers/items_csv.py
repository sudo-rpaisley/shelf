            ...
            try:
                ...
                if isbn_pair:
                    ...
                    existing = db.execute(
                        ...
                        "(isbn IN (?, ?) OR isbn10 IN (?, ?))",
                        (media, isbn13, isbn10, isbn13, isbn10),
                    ).fetchone()
                elif isbn_val:
                ...
                if existing:
                    ...
                    if fmt != reading_imports.GENERIC:
                        # Keep compatibility catalogue fields up to date through
                        # the central value funnel; built-in personal UI reads
                        # user_item_state for the importing account.
