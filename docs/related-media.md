...
Direct relationships can be removed from the item where they were created. Removing one edge can split a larger group; other independent links are left intact.
